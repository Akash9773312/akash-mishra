 ...
 *
 * Persistent outputs:
 * - registry/registry.autogenerated.json
...
/**
 * Build registry/registry.autogenerated.json, registry/__index__.tsx
 */
...
export const Index: Record<string, any> = {`
  ...
  // Build registry/registry.autogenerated.json
  const registryJSON = JSON.stringify(
    {
      $schema: "https://ui.shadcn.com/schema/registry.json",
      name: "Akash Mishra",
      homepage: "https://akashmishra.dev",
      items: registry.items
        .filter((item) => item.type !== "registry:example")
        .map((item) => {
          return {
            ...item,
            author: item.author ?? "Akash Mishra",
            files:
              item.files?.map((file) => {
  ...
  // Build registry/registry.autogenerated.json
  console.log("📦 Building registry/registry.autogenerated.json...")
...
async function buildBlocksIndex() {
  ...
  // Build registry/__blocks__.json
...
/**
 * Copy registry/components to registry/transformed/components with transformations:
...
try {
  ...
  console.log(
    "\n📋 Copying compiled components to registry/transformed/components..."
  )
