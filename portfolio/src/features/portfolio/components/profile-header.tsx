  ...
  return (
    <div className="screen-line-bottom flex border-x border-line">
      <div className="shrink-0 border-r border-line">
        <div className="mx-0.5 my-0.75 flex size-30 items-center justify-center rounded-full bg-muted ring-1 ring-border min-[24rem]:size-32 sm:size-40">
          <LogoMark className="size-1/2 text-foreground" />
        </div>
      </div>
