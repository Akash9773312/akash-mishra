export const registryConfig = {
   ...
   * @example "@akashmishra" - Users can install components with: `npx shadcn add @akashmishra/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@akashmishra",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://akashmishra.dev/r/{name}.json" resolves to "https://akashmishra.dev/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://akashmishra.dev/r/{name}.json",
}
